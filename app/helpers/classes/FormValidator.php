<?PHP
	/*
	-------------------------------------------------------------------------
	PHP Form Validator (formvalidator.php) Version 1.1
	...
	**/
	class CustomValidator {
		public function DoValidate ( &$formars, &$error_hash ) {
			return true;
		}
	}
	...
	**/
	class FormValidator {
		...
		public function validateForm ( ) {
			...
			if ( strcmp( $_SERVER['REQUEST_METHOD'], 'POST' ) == 0 || strcmp( $_SERVER['REQUEST_METHOD'], 'PUT' ) == 0 ) {
