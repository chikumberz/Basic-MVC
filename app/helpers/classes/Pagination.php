<?php
     ...
     * pagination markup (html) through the included pagination.inc.php file.
     *
    ...
    class Pagination {
        ...
        protected $_variables = array(
            'classes'              => array( 'clearfix', 'pagination', 'justify-content-center' ),
            'crumbs'               => 5,
            'rpp'                  => 10,
            'key'                  => 'page',
            'target'               => '',
         ...
         * @param   integer $rpp (default: null)
         * @return  void
         */
        public function __construct ( $current = null, $total = null, $rpp = null ) {
        ...
        protected function _check ( ) {
            ...
            } else if ( isset( $this->_variables['total'] ) === false ) {
         ...
         * logic found in the pagination.inc.php file.
         *
         * @access  public
         * @return  void
         */
        public function parse ( ) {
            ...
            include( $__CONFIG__['directory']['app']['helpers']['includes']['dir'] . 'pagination.php' );
