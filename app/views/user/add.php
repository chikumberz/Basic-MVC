...
<form action="<?php echo getUrl( 'user/save', false, false, true ); ?>" method="post" enctype="multipart/form-data">
	<div class="card shadow">
	    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between pos-r">
	      	<h6 class="m-0 fw-b text-primary">Add User</h6>

	      	<img src="<?php echo $__CONFIG__['directory']['theme']['images']['path']; ?>logo.png" alt="" id="user-photo" width="150px" height="150px" class="bg-ffffff p-5 pos-a pos-b-5 pos-r-20 bc-dcdcdc bs-1 br-3 mb-10" style="object-fit: cover;">
	    </div>
		    		...
		    		<div class="form-group row">
						...
						<div class="col-sm-5">
							<div class="custom-file">
							  	...
							  	<label class="custom-file-label" for="field-photo">Choose file...</label>
							</div>
						</div>
