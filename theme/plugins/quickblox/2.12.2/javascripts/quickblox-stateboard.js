...
;( function ( window, QB_CONFIG, $, _ ) {
    ...
    StateBoard.prototype.update = function ( params ) {
        ...
        try {
            ...
            if ( QB_CONFIG.MESSAGES[params.title] ) {
                msg = QB_CONFIG.MESSAGES[params.title];
            } else {
                msg = params.title;
            }
        }
     ...
     */
    window.QB_APP.helpers.StateBoard = StateBoard;
} ( window, window.QB_CONFIG, jQuery, _ ) );
